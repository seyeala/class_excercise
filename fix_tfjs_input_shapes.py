# fix_tfjs_input_shapes.py
#
# Post-process a TF.js model.json exported from Keras 3.x so that
# InputLayer configs include `batch_input_shape` (which TensorFlow.js
# expects) in addition to `batch_shape`.
